  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4">
      <div className="card max-w-md w-full text-center">
        {/* Logo */}
        <div className="flex justify-center mb-6 logo-animate">
          <Image
            src="/logo.png"
            alt={serverName}
            width={180}
        ...
        <h1 className="text-2xl mb-2">{serverName}</h1>
        <p className="text-[#8b7355] mb-8 font-['Special_Elite'] tracking-wider uppercase text-sm">
